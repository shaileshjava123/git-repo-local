...
<html lang="en">
	<head>
		<meta charset="utf-8">
		<title>AKB INDIA REGISTRATION/LOGIN</title>
    ...
    <body>		
		...
		<div id="wrapper" class="container">
			...
			<img class="pageBanner" src="themes/images/pageBanner.png" alt="New products" >
				...
				<h4 style="color: red"><span>${regStatusRed}</span></h4>
				<h4 style="color: green"><span>${regStatusGreen}</span></h4>
			</section>			
						...
						<form action="register" method="post" class="form-stacked" >
							<fieldset>
								...
								<div class="control-group">
									...
									<div class="controls"> 
										<input type="password" placeholder="Enter your email" class="input-xlarge" name="email">
									</div>
								</div>
								<div class="control-group">
