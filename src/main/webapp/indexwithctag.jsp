...
<!--[if lt IE 9]>			
			<script src="<c:url value="/resources/http://html5shim.googlecode.com/svn/trunk/html5.js" />"></script>
...
<body>
	...
	<div id="wrapper" class="container">
		...
		<section class="header_text"> We stand for top quality
		templates. Our genuine developers always optimized bootstrap
		commercial templates. <br />
		Don't miss to use our cheap abd best bootstrap templates. </section>
									...
									<ul class="thumbnails">
										<li class="span3">
											<div class="product-box">
												...
												<a href="product_detail.jsp" class="title">Ut wisi enim
										...
										<li class="span3">
											<div class="product-box">
												...
												<a href="product_detail.jsp" class="title">Quis nostrud
										...
										<li class="span3">
											<div class="product-box">
												...
												<a href="product_detail.jsp" class="title">Know exactly
										...
										<li class="span3">
											<div class="product-box">
												...
												<a href="product_detail.jsp" class="title">You think
